...
Public Class frmDieuchinhKH
    ...
    Private Sub frmDieuchinhKH_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim refesh As SqlDataAdapter = New SqlDataAdapter("select MAKH as 'Mã khách hàng' ,TENKH as 'Tên khách hàng', DIACHI as 'Địa chỉ', SDT as 'Số điện thoại', EMAIL from KHACHHANG", conn)
        db.Clear()
        refesh.Fill(db)
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        ...
        connect.Open()
        Dim xem As SqlDataAdapter = New SqlDataAdapter("select MAKH as 'Mã khách hàng' ,TENKH as 'Tên khách hàng', DIACHI as 'Địa chỉ', SDT as 'Số điện thoại', EMAIL from KHACHHANG where MAKH=N'" & txtMaKH.Text & "'", connect)
        Try
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim load As SqlDataAdapter = New SqlDataAdapter("select MAKH as 'Mã khách hàng' ,TENKH as 'Tên khách hàng', DIACHI as 'Địa chỉ', SDT as 'Số điện thoại', EMAIL from KHACHHANG", conn)
